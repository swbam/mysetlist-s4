...
async function checkAndCreateSetlists() {
  try {
    ...
    console.log(`Found ${existingSetlists?.length || 0} setlists for this show`);

    if (!existingSetlists || existingSetlists.length === 0) {
      console.log('No setlists found. Creating real setlist for Arctic Monkeys...');
      ...
      const arcticMonkeysSongs = [
        ...
        { title: "R U Mine?", artist_id: shows.headliner_artist_id, duration: 202 },
        { title: "Do I Wanna Know?", artist_id: shows.headliner_artist_id, duration: 272 },
        { title: "Brianstorm", artist_id: shows.headliner_artist_id, duration: 182 },
        { title: "505", artist_id: shows.headliner_artist_id, duration: 253 },
        { title: "Fluorescent Adolescent", artist_id: shows.headliner_artist_id, duration: 178 },
        { title: "Why'd You Only Call Me When You're High?", artist_id: shows.headliner_artist_id, duration: 161 },
        { title: "I Bet You Look Good on the Dancefloor", artist_id: shows.headliner_artist_id, duration: 173 },
        { title: "When the Sun Goes Down", artist_id: shows.headliner_artist_id, duration: 200 },
        { title: "Arabella", artist_id: shows.headliner_artist_id, duration: 207 },
        { title: "Snap Out of It", artist_id: shows.headliner_artist_id, duration: 193 },
        { title: "Teddy Picker", artist_id: shows.headliner_artist_id, duration: 164 },
        { title: "Crying Lightning", artist_id: shows.headliner_artist_id, duration: 223 },
        { title: "Cornerstone", artist_id: shows.headliner_artist_id, duration: 197 },
        { title: "Mardy Bum", artist_id: shows.headliner_artist_id, duration: 175 },
        { title: "Four Out of Five", artist_id: shows.headliner_artist_id, duration: 312 },
        { title: "One Point Perspective", artist_id: shows.headliner_artist_id, duration: 208 },
        { title: "American Sports", artist_id: shows.headliner_artist_id, duration: 158 },
        { title: "The View from the Afternoon", artist_id: shows.headliner_artist_id, duration: 218 },
        { title: "Pretty Visitors", artist_id: shows.headliner_artist_id, duration: 220 },
        { title: "Body Paint", artist_id: shows.headliner_artist_id, duration: 276 }
      ];
      ...
      const totalDuration = arcticMonkeysSongs.slice(0, 20).reduce((sum, song) => sum + song.duration, 0);
      await supabase
        .from('setlists')
        .update({ 
