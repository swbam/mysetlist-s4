          ...
          <Container className="mx-auto py-12">
            <Section className="mt-8 rounded-md bg-zinc-200 p-px">
              <Section className="rounded-[5px] bg-white p-8">
                ...
                <Text className="text-zinc-700">
                  Don't miss out! <strong>{show.artistName}</strong> is performing {timeText}.
                </Text>
                ...
                <Section className="text-center space-y-3">
                  <Button
                    ...
                    className="bg-zinc-900 text-white px-6 py-3 rounded-md font-medium mr-4"
                  >
                    View Show Details
                  </Button>
                  {show.ticketUrl && (
                ...
                <Text className="text-zinc-500 text-sm">
                  You're receiving this reminder because you follow {show.artistName}.
