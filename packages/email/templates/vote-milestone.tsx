        ...
        <Container className="mx-auto py-12">
          <Section className="mt-8 rounded-md bg-zinc-200 p-px">
            <Section className="rounded-[5px] bg-white p-8">
              ...
              <Text className="text-zinc-700">
                Exciting news! A song you voted for has reached a major milestone.
              </Text>
              
              <Section className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-md my-6 border border-green-100">
                <Text className="font-bold text-zinc-900 mb-2 text-xl">
                  "{song.title}"
                </Text>
                ...
                <Section className="bg-white/70 p-4 rounded border border-green-200">
                  <Text className="font-semibold text-green-800 mb-1">
                    🎉 {milestone} Vote Milestone!
                  </Text>
                  <Text className="text-green-700 text-sm">
                    This song is really resonating with fans. Your vote helped make this happen!
                  </Text>
                </Section>
              </Section>

              <Section className="bg-blue-50 p-4 rounded-md my-6 border border-blue-100">
              ...
              <Section className="text-center">
                <Text className="text-zinc-600 mb-4">
                  Keep the momentum going! Vote for more songs you'd love to hear.
                </Text>
              ...
              <Section className="bg-zinc-50 p-4 rounded-md">
                ...
                <Text className="text-zinc-600 text-sm">
                  Songs with higher vote counts are more likely to be played at the show. 
                  Your participation helps artists understand what fans want to hear most!
                </Text>
              </Section>
              ...
              <Text className="text-zinc-500 text-sm">
                You're receiving this notification because you voted for this song.
                You can manage your notification preferences{' '}
                <Link href={`${appUrl}/settings`} className="text-zinc-700 underline">
                  here
                </Link>{' '}
                or{' '}
                <Link href={`${appUrl}/unsubscribe?type=vote-milestones`} className="text-zinc-700 underline">
