        ...
        <div className="mt-6">
          ...
          <div className="mt-6">
            <button
              ...
              disabled={loading}
              className="flex w-full items-center justify-center gap-3 rounded-md bg-[#1DB954] px-3 py-1.5 text-white hover:bg-[#1aa34a] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#1DB954] focus-visible:outline-offset-2 disabled:opacity-50"
            >
