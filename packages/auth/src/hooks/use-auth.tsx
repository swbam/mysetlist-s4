...
interface AuthContextType {
  ...
  signUpWithEmail: (email: string, password: string, metadata?: Record<string, any>) => Promise<AuthUser>;
...
export function AuthProvider({ children, initialSession }: AuthProviderProps) {
  ...
  useEffect(() => {
    ...
    const { data: { subscription } } = authProvider.onAuthStateChange(
      async (event, session) => {
  ...
  const hasRole = useCallback((requiredRole: 'user' | 'moderator' | 'admin') => {
