...
class TicketmasterAPI {
  ...
  async searchEvents(params: {
    ...
    return this.makeRequest<TicketmasterSearchResponse<TicketmasterEvent>>('/events.json', params);
  }
  ...
  async searchAttractions(params: {
    ...
    return this.makeRequest<TicketmasterSearchResponse<any>>('/attractions.json', params);
  }
  ...
  async searchVenues(params: {
    ...
    return this.makeRequest<TicketmasterSearchResponse<TicketmasterVenue>>('/venues.json', params);
  }
  ...
  async getUpcomingEvents(artistName: string, options: {
    size?: number;
    page?: number;
    sort?: string;
    startDateTime?: string;
