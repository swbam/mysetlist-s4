...
export const cacheKeys = {
  spotify: {
    ...
    artistTopTracks: (id: string, market = 'US') => `spotify:artist:${id}:top-tracks:${market}`,
    searchArtists: (query: string, limit: number) => `spotify:search:artists:${query}:${limit}`,
    searchTracks: (query: string, limit: number) => `spotify:search:tracks:${query}:${limit}`,
  },
  ticketmaster: {
  ...
  setlistfm: {
    ...
    artistSetlists: (mbid: string, page: number) => `setlistfm:artist:${mbid}:setlists:${page}`,
    venueSetlists: (id: string, page: number) => `setlistfm:venue:${id}:setlists:${page}`,
    searchArtists: (name: string, page: number) => `setlistfm:search:artists:${name}:${page}`,
  },
};