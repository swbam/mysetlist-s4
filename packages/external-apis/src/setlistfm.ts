...
class SetlistFmAPI {
  ...
  async searchSetlists(params: {
    ...
    return this.makeRequest<SetlistFmSearchResponse<SetlistFmSetlist>>('/search/setlists', params);
  }
  ...
  async searchArtists(params: {
    ...
    return this.makeRequest<SetlistFmSearchResponse<SetlistFmArtist>>('/search/artists', params);
  }
  ...
  async getArtistSetlists(mbid: string, params: {
    p?: number;
  } = {}): Promise<SetlistFmSearchResponse<SetlistFmSetlist>> {
    return this.makeRequest<SetlistFmSearchResponse<SetlistFmSetlist>>(`/artist/${mbid}/setlists`, params);
  }
  ...
  async searchVenues(params: {
    ...
    return this.makeRequest<SetlistFmSearchResponse<SetlistFmVenue>>('/search/venues', params);
  }
  ...
  async getVenueSetlists(venueId: string, params: {
    p?: number;
  } = {}): Promise<SetlistFmSearchResponse<SetlistFmSetlist>> {
    return this.makeRequest<SetlistFmSearchResponse<SetlistFmSetlist>>(`/venue/${venueId}/setlists`, params);
  }

  async getRecentSetlists(artistName: string, limit = 10): Promise<SetlistFmSetlist[]> {
...
export type { SetlistFmSetlist, SetlistFmArtist, SetlistFmVenue, SetlistFmSong };