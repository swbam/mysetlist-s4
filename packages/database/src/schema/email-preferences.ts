...
export const emailPreferences = pgTable('email_preferences', {
  ...
  showReminderFrequency: emailFrequencyEnum('show_reminder_frequency').default('daily').notNull(),
  
  // New show announcements
  newShowNotifications: boolean('new_show_notifications').default(true).notNull(),
  newShowFrequency: emailFrequencyEnum('new_show_frequency').default('immediately').notNull(),
  
  // Setlist updates
  setlistUpdates: boolean('setlist_updates').default(true).notNull(),
  setlistUpdateFrequency: emailFrequencyEnum('setlist_update_frequency').default('immediately').notNull(),
