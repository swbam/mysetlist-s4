...
const sampleArtists = [
  ...
  },
  {
    ...
    genres: JSON.stringify(['canadian contemporary r&b', 'canadian pop', 'pop']),
    popularity: 95,
    followers: 72000000,
  ...
  },
  {
    ...
    genres: JSON.stringify(['garage rock', 'modern rock', 'permanent wave', 'rock', 'sheffield indie']),
    popularity: 88,
    followers: 25000000,
  ...
  },
  {
    ...
    genres: JSON.stringify(['art rock', 'melancholia', 'oxford indie', 'permanent wave', 'rock']),
    popularity: 82,
    followers: 12000000,
