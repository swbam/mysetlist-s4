...
export const env = createEnv({
  ...
  server: {
    ...
    // Supabase (CRITICAL - was missing!)
    SUPABASE_URL: z.string().url(),
    SUPABASE_ANON_KEY: z.string().min(1),
    SUPABASE_SERVICE_ROLE_KEY: z.string().min(1),
    
    // Spotify API (CRITICAL - was missing!)
  ...
  runtimeEnv: {
    ...
    SETLISTFM_API_KEY: process.env['SETLISTFM_API_KEY'] || process.env['SETLIST_FM_API_KEY'],
    ...
    NEXT_PUBLIC_SPOTIFY_CLIENT_ID: process.env['NEXT_PUBLIC_SPOTIFY_CLIENT_ID'] || process.env['SPOTIFY_CLIENT_ID'],
