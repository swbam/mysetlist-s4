...
describe('/api/admin/users', () => {
  ...
  describe('GET', () => {
    ...
    it('should apply search filters correctly', async () => {
      ...
      const request = new NextRequest('http://localhost/api/admin/users?search=test&role=moderator&status=active');
      const response = await GET(request);

      expect(mockQuery.or).toHaveBeenCalledWith('email.ilike.%test%,display_name.ilike.%test%,username.ilike.%test%');
