...
describe('/api/admin/analytics/votes', () => {
  ...
  describe('GET', () => {
    it('should return 401 if user is not authenticated', async () => {
      ...
      const request = new NextRequest('http://localhost/api/admin/analytics/votes');
    ...
    it('should return vote analytics for admin user', async () => {
      ...
      const request = new NextRequest('http://localhost/api/admin/analytics/votes?period=7d');
      const response = await GET(request);
      const data = await response.json();
    ...
    it('should handle different time periods correctly', async () => {
      ...
      // Test 30 day period
      const request = new NextRequest('http://localhost/api/admin/analytics/votes?period=30d');
      const response = await GET(request);
    ...
    it('should filter by vote type when specified', async () => {
      ...
      const request = new NextRequest('http://localhost/api/admin/analytics/votes?vote_type=played');
      const response = await GET(request);
