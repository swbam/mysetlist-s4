  ...
  return (
    ...
    >
      ...
      {enableVisualFeedback && isDragging && (
        <>
          {dragDirection === "left" &&
            React.createElement(GestureBackground as any, {
              direction: "left",
...
export function withGestureSupport<P extends object>(
  ...
  return memo(function GestureEnabledComponent(props: P) {
    ...
    if (gestureConfig?.leftActions !== undefined) {
      gestureProps.leftActions = gestureConfig.leftActions;
    }
    if (gestureConfig?.rightActions !== undefined) {
      gestureProps.rightActions = gestureConfig.rightActions;
    }
    if (gestureConfig?.enableHapticFeedback !== undefined) {
      gestureProps.enableHapticFeedback = gestureConfig.enableHapticFeedback;
    }

    return (
      <AdvancedGestureHandler {...gestureProps}>
        <Component {...props} />
