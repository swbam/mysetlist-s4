...
const profileSchema = z.object({
  ...
  spotifyUsername: z.string().max(50, 'Spotify username must be less than 50 characters').optional(),
});
    ...
    const fetchProfile = async () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          setValue('displayName', profile.displayName || user.email?.split('@')[0] || '');
        ...
        <div className="container mx-auto px-4 py-8">
          <Card className="max-w-2xl mx-auto">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Your profile has been successfully updated. You will be redirected to your profile page.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="flex gap-2">
                        <Label htmlFor="avatar-upload" className="cursor-pointer">
                          <div className="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium border border-input rounded-md hover:bg-accent hover:text-accent-foreground">
                ...
                {/* Spotify Username */}
                <div className="space-y-2">
                  <Label htmlFor="spotifyUsername" className="flex items-center gap-2">
                  ...
                  {errors.spotifyUsername && (
                    <p className="text-sm text-destructive">{errors.spotifyUsername.message}</p>
                  )}
                </div>
