...
export async function TrendingShowsSlider() {
  try {
    ...
    if (!res.ok) {
      console.warn(
        `Failed to fetch trending shows: ${res.status} ${res.statusText}`,
      );
      return (
          ...
          <div className="container mx-auto px-4">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Unable to load trending shows at the moment. Please try again
                later.
              </p>
            </div>
          </div>
        ...
        <div className="py-16 md:py-24">
          <div className="container mx-auto px-4">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                No trending shows found. Check back soon for updates!
              </p>
            </div>
          </div>
        </div>
