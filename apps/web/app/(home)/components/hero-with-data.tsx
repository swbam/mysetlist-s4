...
export async function HomeHeroWithData() {
  const { stats, trendingArtists } = await getHomePageStats();
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mx-auto max-w-5xl text-center">
          <div className="space-y-6 animate-slide-up">
            ...
            >
              ...
              <span className="font-medium text-sm">
                {stats.activeShows > 0 
                  ? `Trending Now: ${formatNumber(stats.activeShows)} Active Shows`
          ...
          <div className="mt-12 space-y-4 px-4 sm:px-0 animate-slide-up-delay-1">
            ...
            {/* Quick search suggestions - only show if we have data */}
          ...
          {(stats.activeArtists > 0 || stats.votesCast > 0 || stats.musicFans > 0) && (
            <div
            ...
            >
              {stats.activeArtists > 0 && (
                <div className="text-center">
                  <div 
                    ...
                    aria-label={`${formatNumber(stats.activeArtists)} artists`}
                  >
              ...
              {stats.musicFans > 0 && (
                <div className={stats.activeArtists > 0 && stats.votesCast > 0 ? "col-span-2 text-center md:col-span-1" : "text-center"}>
                  <div className="font-bold text-2xl text-white sm:text-3xl md:text-4xl">
                    {formatNumber(stats.musicFans)}
                  </div>
                  <div className="mt-1 text-muted-foreground text-xs sm:text-sm">
                    Music Fans
                  </div>
