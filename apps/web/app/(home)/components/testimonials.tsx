        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div className="flex flex-col gap-4 rounded-md border p-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              "MySetlist changed how I experience live music. Being able to vote
          ...
          <div className="flex flex-col gap-4 rounded-md border p-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-xs">Concert Regular</p>
              </div>
            </div>
          </div>
          <div className="flex flex-col gap-4 rounded-md border p-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-xs">Music Explorer</p>
              </div>
            </div>
          </div>
        </div>
