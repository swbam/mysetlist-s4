...
const formatFollowers = React.useCallback((num: number) => {
  if (num >= 1000000) {
...
// Memoized artist card component to prevent unnecessary re-renders
const ArtistCard = React.memo(({ artist, index }: { artist: TrendingArtist; index: number }) => (
...
const TopArtistsSlider = React.memo(({ artists }: TopArtistsSliderProps) => {
...
TopArtistsSlider.displayName = 'TopArtistsSlider';
