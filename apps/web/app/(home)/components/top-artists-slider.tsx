	...
	return (
		<section className="py-16">
			<div className="container mx-auto px-4">
				<h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-8 text-white">Top Artists</h2>
				<div ref={sliderRef} className="keen-slider">
					{artists.map((artist) => (
						<Card key={artist.id} className="keen-slider__slide bg-card/70 backdrop-blur-sm border border-white/10">
