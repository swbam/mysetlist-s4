...
export async function POST(request: NextRequest) {
  try {
    ...
    const seedResponse = await fetch(`${process.env.NEXT_PUBLIC_APP_URL}/api/admin/seed-trending`, {
      method: 'POST',
      headers: {
    ...
    await fetch(`${process.env.NEXT_PUBLIC_APP_URL}/api/admin/calculate-trending`, {
      method: 'POST',
    });
