...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.log(`[IMPORT] Starting orchestrator import for tmAttractionId: ${tmAttractionId}`);
    ...
    return NextResponse.json(
      { 
        ...
        progressEndpoint: targetArtistId ? `/api/artists/${targetArtistId}/import-progress` : undefined,
      },
      { status: 500 },
    );
  }
