    ...
    <div className="container mx-auto py-8">
      <div className="mx-auto max-w-4xl space-y-8">
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                ...
                your voting patterns, show attendance, and interaction with
                content.
              </p>
            </div>
            <div>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                ...
                including personalized recommendations and notifications.
              </p>
            </div>
            <div>
              <h3 className="mb-2 font-semibold">Communication</h3>
              <p className="text-muted-foreground text-sm">
                We may send you emails about your account, service updates, and
                promotional content (which you can opt out of).
              </p>
            </div>
            <div>
              <h3 className="mb-2 font-semibold">Analytics</h3>
              <p className="text-muted-foreground text-sm">
                We analyze usage patterns to improve our service and understand
                user preferences.
              </p>
            </div>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              <h3 className="mb-2 font-semibold">Access and Correction</h3>
              <p className="text-muted-foreground text-sm">
            ...
            <div>
              <h3 className="mb-2 font-semibold">Deletion</h3>
              <p className="text-muted-foreground text-sm">
            ...
            <div>
              <h3 className="mb-2 font-semibold">Data Portability</h3>
              <p className="text-muted-foreground text-sm">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-muted-foreground text-sm">
              ...
              contact us at privacy@mysetlist.com
            </p>
          </CardContent>
        </Card>
      </div>
