...
import { Share2, Twitter, Facebook, Link2, Check, Mail, MessageCircle, Music } from 'lucide-react';
...
export function ShareButtons({ 
  ...
  const encodedDescription = encodeURIComponent(description || `Check out ${title} on MySetlist`);
    ...
    <Dialog open={showEmbedDialog} onOpenChange={setShowEmbedDialog}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Copy the embed code below to add this show to your website or blog.
          </DialogDescription>
        </DialogHeader>
