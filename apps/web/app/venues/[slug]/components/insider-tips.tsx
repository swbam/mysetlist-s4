...
import { Lightbulb, ThumbsUp, Car, Utensils, MapPin, Ticket, Music, Info } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-semibold">Insider Tips</h2>
          ...
          {categories.length > 1 && (
            <div className="flex flex-wrap gap-2">
              ...
              {categories.map(category => {
                ...
                const count = tips.filter(t => t.tipCategory === category).length;
