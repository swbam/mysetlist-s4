...
export const EnhancedLoadingSkeleton = React.memo(
  function EnhancedLoadingSkeleton({
    ...
    return (
      <div
        className={cn("py-16 md:py-24", animated && "animate-pulse", className)}
        role="status"
        aria-label="Loading content"
      >
        <div className="container mx-auto px-4">{getSkeletonContent()}</div>
      </div>
    );
  },
);
