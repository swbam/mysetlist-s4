...
export function SetlistManager({
  ...
  const [isRealtimeEnabled, setIsRealtimeEnabled] = useState(show.status === 'ongoing');
  ...
  const createNewSetlist = async (type: 'predicted' | 'actual') => {
    try {
      ...
      toast.success(`${type === 'actual' ? 'Actual' : 'Predicted'} setlist created`);
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <Label htmlFor="voting-stats" className="flex items-center gap-1">
              ...
              <TabsList className="grid w-full grid-cols-2">
                <TabsTrigger value="predicted" className="flex items-center gap-2">
                  ...
                  {predictedSetlists.length > 0 && (
                    <Badge variant="secondary">{predictedSetlists.length}</Badge>
                  )}
                </TabsTrigger>
                ...
                {predictedSetlists.length > 0 ? (
                  ...
                  <Card>
                    <CardContent className="text-center py-12">
                      ...
                      <h3 className="text-lg font-medium mb-2">No predicted setlists yet</h3>
                ...
                {actualSetlists.length > 0 ? (
                  ...
                  <Card>
                    <CardContent className="text-center py-12">
                      ...
                      <h3 className="text-lg font-medium mb-2">No actual setlists yet</h3>
                      <p className="text-muted-foreground mb-4">
                        {show.status === 'completed' 
