...
import { User, Music, Crown, Shield } from 'lucide-react';
...
export function UserAvatar({
  ...
  const getRoleBadge = () => {
    ...
    const roleConfig = {
      admin: { label: 'Admin', variant: 'default' as const, className: 'bg-yellow-100 text-yellow-800' },
      moderator: { label: 'Mod', variant: 'secondary' as const, className: 'bg-blue-100 text-blue-800' },
    };
