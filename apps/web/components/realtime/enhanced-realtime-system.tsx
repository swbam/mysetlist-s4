...
export function useEnhancedRealtimeConnection() {
  ...
  }, [announce, measureLatency, reconnect, connectionState.reconnectAttempts, connectionState.maxReconnectAttempts]);
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              {connectionState.lastConnected && (
                <div>
                  ...
                  <p className="font-medium">{connectionState.lastConnected.toLocaleTimeString()}</p>
                </div>
              )}
              {connectionState.disconnectedAt && (
                <div>
                  <span className="text-muted-foreground">Disconnected:</span>
                  <p className="font-medium">{connectionState.disconnectedAt.toLocaleTimeString()}</p>
                </div>
              )}
            </div>
            ...
            {connectionState.status === 'reconnecting' && (
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span>{connectionState.reconnectAttempts}/{connectionState.maxReconnectAttempts}</span>
                </div>
                <Progress 
                  value={(connectionState.reconnectAttempts / connectionState.maxReconnectAttempts) * 100}
                  className="h-2"
                />
              </div>
            )}
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <p className="font-medium">{formatUptime(metrics.connectionUptime)}</p>
              </div>
            </div>
          </div>
        </CardContent>
