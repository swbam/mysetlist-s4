    ...
    <div className={cn("flex items-center gap-1", className)}>
      <Button
        ...
        className={cn(
          ...
          votes.userVote === 'up' && 'bg-green-100 text-green-700 hover:bg-green-200 dark:bg-green-900/30 dark:text-green-400'
        )}
      ...
      <span className={cn(
        'text-sm font-medium min-w-[2rem] text-center tabular-nums',
      ...
      <Button
        ...
        className={cn(
          'h-8 w-8 p-0 transition-all',
          votes.userVote === 'down' && 'bg-red-100 text-red-700 hover:bg-red-200 dark:bg-red-900/30 dark:text-red-400'
        )}
