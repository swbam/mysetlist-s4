...
import { Cookie, Settings, Shield, BarChart3, MapPin } from 'lucide-react';
...
export function GDPRCookieConsent() {
  ...
  useEffect(() => {
    ...
    if (!consent) {
      ...
      initializeAnalytics(preferences ? JSON.parse(preferences) : { analytics: false });
    }
  }, []);
  ...
  const savePreferences = (prefs: CookiePreferences) => {
    ...
    localStorage.setItem('mysetlist-cookie-consent-date', new Date().toISOString());
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    ...
                    You can choose which cookies to accept. Some cookies are necessary for the site to function properly.
                  </p>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground ml-8">
                These cookies are essential for authentication, security, and basic site functionality. 
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground ml-8">
                We use PostHog and Google Analytics to track page views, user interactions, 
                and site performance to improve our service.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground ml-8">
                These cookies track your activity across websites to show you relevant ads 
