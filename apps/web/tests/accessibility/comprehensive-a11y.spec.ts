...
test.describe('Accessibility Tests', () => {
  ...
  test('voting interface should be accessible', async ({ page }) => {
    ...
    const voteButtons = page.locator('button[aria-label*="vote"], button[aria-label*="upvote"], button[aria-label*="downvote"]');
  ...
  test('focus management should work correctly', async ({ page }) => {
    ...
    const dialogTrigger = page.locator('button[aria-haspopup="dialog"], [data-testid="modal-trigger"]').first();
