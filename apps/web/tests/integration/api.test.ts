...
describe('API Integration Tests', () => {
  ...
  describe('Search API', () => {
    it('should search artists successfully', async () => {
      ...
      // Test search
      const response = await fetch(`${process.env.TEST_BASE_URL}/api/search?q=Test Artist`);
    ...
    it('should handle empty search queries', async () => {
      const response = await fetch(`${process.env.TEST_BASE_URL}/api/search?q=`);
      const data = await response.json();
    ...
    it('should filter search results by type', async () => {
      ...
      // Test artist filter
      const artistResponse = await fetch(`${process.env.TEST_BASE_URL}/api/search?q=Test&type=artist`);
      ...
      // Test venue filter
      const venueResponse = await fetch(`${process.env.TEST_BASE_URL}/api/search?q=Test&type=venue`);
  ...
  describe('Health Check API', () => {
    it('should return system health status', async () => {
      const response = await fetch(`${process.env.TEST_BASE_URL}/api/health/comprehensive`);
      const data = await response.json();
  ...
  describe('Trending API', () => {
    it('should return trending artists', async () => {
      ...
      const response = await fetch(`${process.env.TEST_BASE_URL}/api/trending/artists?limit=2`);
      const data = await response.json();
    ...
    it('should return trending shows', async () => {
      ...
      const response = await fetch(`${process.env.TEST_BASE_URL}/api/trending/shows?limit=1`);
      const data = await response.json();
