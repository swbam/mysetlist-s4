...
serve(async (req) => {
  ...
  try {
    ...
    switch (type) {
      case 'new_show':
        emailsSent = await sendNewShowNotifications(
          supabase,
          resendApiKey,
          artistId
        );
      ...
      case 'show_reminder':
        ...
        break;
      case 'artist_update':
        emailsSent = await sendArtistUpdateNotifications(
          supabase,
          resendApiKey,
          artistId
        );
...
async function sendNewShowNotifications(
  supabase: any,
  resendKey: string,
  artistId?: string
) {
...
async function sendShowReminders(
  supabase: any,
  resendKey: string,
  showId?: string
) {
...
async function sendArtistUpdateNotifications(
  supabase: any,
  resendKey: string,
  artistId?: string
) {
