  ...
  if (existingVenue.length > 0) {
    ...
    await db
      ...
      .set({
        ...
        ...(tmVenue.location?.latitude && { latitude: parseFloat(tmVenue.location.latitude) }),
        ...(tmVenue.location?.longitude && { longitude: parseFloat(tmVenue.location.longitude) }),
        ...(tmVenue.timezone && { timezone: tmVenue.timezone }),
        ...(tmVenue.url && { website: tmVenue.url }),
        ...(extractPhoneNumber(tmVenue) && { phoneNumber: extractPhoneNumber(tmVenue) }),
