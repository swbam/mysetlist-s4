...
export const bullMQConnection: ConnectionOptions = REDIS_URL
  ? { 
      ...
      port: 6380,
      password: "AZJWAAIncDE5ODdhYmJiZGQ3MGM0MTE2OTRlZTYzMWQyYThjYjc1NXAxMzc0NjI",
      tls: {},
...
export class SimpleQueue {
  ...
  async add(jobName: string, data: any, options: { delay?: number; attempts?: number } = {}): Promise<string> {
