...
export function generateShowMeta({
  ...
  return generateSocialMeta({
    ...
    tags: [artistName, venueName, venueCity, 'concert', 'live music', 'setlist'],
  });
}
...
export function generateArtistMeta({
  ...
  return generateSocialMeta({
    ...
    url: artistUrl,
    type: 'profile',
    tags: genres ? [artistName, ...genres, 'artist', 'music'] : [artistName, 'artist', 'music'],
  });
}
...
export function generateDiscoverMeta(): Metadata {
  return generateSocialMeta({
    ...
    description: 'Get personalized recommendations for shows, artists, and venues based on your music taste. Discover your next favorite concert on MySetlist.',
    type: 'website',
    tags: ['discover', 'recommendations', 'personalized', 'concerts', 'live music'],
  });
}