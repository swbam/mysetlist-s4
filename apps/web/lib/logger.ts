...
class Logger {
  ...
  error(message: string, errorOrContext?: Error | LogContext, context?: LogContext) {
    if (errorOrContext instanceof Error) {
      ...
      this.sentryLogger.error(message, { error: error.message, stack: error.stack, ...context });
  ...
  fatal(message: string, errorOrContext?: Error | LogContext, context?: LogContext) {
    if (errorOrContext instanceof Error) {
      ...
      // Use Sentry's new logging API for structured error logging
      this.sentryLogger.fatal(message, { error: error.message, stack: error.stack, ...context });
