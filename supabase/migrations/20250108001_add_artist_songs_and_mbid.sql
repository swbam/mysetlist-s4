...
ADD COLUMN IF NOT EXISTS mbid TEXT UNIQUE; -- MusicBrainz ID for Setlist.fm
...
-- Enable RLS on artist_songs
ALTER TABLE artist_songs ENABLE ROW LEVEL SECURITY;

-- Create RLS policies for artist_songs (read-only for public)
